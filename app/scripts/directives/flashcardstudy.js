'use strict';
angular.module('crackooApp').directive('flashcardstudy', [function () {
    return {
      templateUrl: 'views/studyItem/flashcard_study.html',
      restrict: 'A',
      scope: {
        item: '=',
        answers: '=',
      ...
      link: function postLink(scope) {
        ...
        scope.edit = function () {
          ...
          scope.tempItem.item = angular.copy(scope.item);
          scope.tempItem.answers = angular.copy(scope.answers);
        ...
        scope.save = function () {
          ...
          //scope.tempContent.front = null;
          //scope.tempContent.back = null;
          scope.item = angular.copy(scope.tempItem.item);
          scope.answers = angular.copy(scope.tempItem.answers);
          scope.tempItem = {};
          scope.isFrontVisible = true;
          //save to server
        };
